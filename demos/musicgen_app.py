...
# Generate an electronic pop track at 120BPM in C major, happy mood. Structure: 4-bar intro, 8-bar verse, 4-bar pre-chorus,
# 8-bar chorus, 8-bar verse, 4-bar pre-chorus, 8-bar chorus, 4-bar bridge, 8-bar chorus, 4-bar outro.
